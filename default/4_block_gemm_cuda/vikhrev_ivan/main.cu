...
int main(int argc, char* argv[]) {
    ...
    auto [res, time] = benchmark(BlockGemmCUDASimple, a, b, n);
    std::cout << "Block GEMM CUDA simple: " << time << " ms" << std::endl;
    ...
    auto [res_opt, time_opt] = benchmark(BlockGemmCUDA, a, b, n);
    std::cout << "Block GEMM CUDA: " << time_opt << " ms" << std::endl;

...
int main(int argc, char* argv[]) {
    ...
    auto [res, time] = benchmark(NaiveGemmCUDASimple, a, b, n);
    std::cout << "Naive GEMM CUDA simple: " << time << " ms" << std::endl;
    ...
    auto [res_opt, time_opt] = benchmark(NaiveGemmCUDA, a, b, n);
    std::cout << "Naive GEMM CUDA: " << time_opt << " ms" << std::endl;
